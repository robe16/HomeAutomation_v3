...
def read_config_users():
    with open(os.path.join(os.path.dirname(__file__), 'config_users.json'), 'r') as data_file:
        ...
        if data != None:
            for id in data['users']:
                if data['users'][id]['name'] == user:
                    ...
                    with open(os.path.join(os.path.dirname(__file__), 'config_users.json'), 'w+') as output_file:
