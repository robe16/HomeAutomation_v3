...
def create_lgtv(type, STRname, STRloungetv_lgtv_ipaddress, STRpairingkey, BOOLtvguide_use, STRgroup):
...
def create_tivo(type, STRname, STRloungetv_tivo_ipaddress, STRaccesskey, BOOLtvguide_use, STRgroup):
