...
def html_menu_lhs():
    ...
    while a_num < len(a_list):
        ...
        #
        html += urlopen('web/html_menu/menu_sidebar_item.html').read().encode('utf-8').format(href=('/web/account/{account_id}').format(account_id=a_list[a_num]),
    ...
    while r_num < len(r_list):
        ...
        while d_num < len(d_list):
            ...
            #
            html += urlopen('web/html_menu/menu_sidebar_item.html').read().encode('utf-8').format(href=('/web/device/{room_id}/{device_id}').format(room_id=r_list[r_num],
